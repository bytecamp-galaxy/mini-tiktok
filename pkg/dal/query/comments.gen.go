...
func (a commentBelongsToVideo) Model(m *model.Comment) *commentBelongsToVideoTx {
	return &commentBelongsToVideoTx{a.db.Model(m).Association(a.Name())}
}

type commentBelongsToVideoTx struct{ tx *gorm.Association }

func (a commentBelongsToVideoTx) Find() (result *model.Video, err error) {
	return result, a.tx.Find(&result)
}

func (a commentBelongsToVideoTx) Append(values ...*model.Video) (err error) {
...
func (a commentBelongsToVideoTx) Replace(values ...*model.Video) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToVideoTx) Delete(values ...*model.Video) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToUser) Model(m *model.Comment) *commentBelongsToUserTx {
	return &commentBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

type commentBelongsToUserTx struct{ tx *gorm.Association }

func (a commentBelongsToUserTx) Find() (result *model.User, err error) {
	return result, a.tx.Find(&result)
}

func (a commentBelongsToUserTx) Append(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToUserTx) Replace(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToUserTx) Delete(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
