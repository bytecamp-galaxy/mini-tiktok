...
type PublishListResponse struct {
	...
	VideoList  []*rpcmodel.Video `thrift:"VideoList,3,required" frugal:"3,required,list<rpcmodel.Video>" json:"VideoList"`
}
...
func (p *PublishListResponse) Field3DeepEqual(src []*rpcmodel.Video) bool {
